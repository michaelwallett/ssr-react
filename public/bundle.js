...
},{"./filterable-restaurant-list.jsx":2}],2:[function(require,module,exports){
// Pagination
...
var RestaurantListHeader = React.createClass({displayName: "RestaurantListHeader",
    ...
    render: function () {
        ...
        if (this.props.location.macro) {
            ...
            seeAll = React.createElement("a", {href: "#", onClick: this.handleClick}, "See all x")
        }

        return (
            React.createElement("div", null, 
                React.createElement("h4", null, 
                    React.createElement("span", null, this.props.restaurants.length, " Restaurants in"), 
